...
app.controller('calculator', function ($scope, $http) {
    $http.get('https://uz.sns.it/~giove/pandemic/deck/').then(
        ...
        function (data) {
            $scope.cities = [{"color": "blue", "multiplicity": 1, "name": "Atlanta"}, {"color": "blue", "multiplicity": 2, "name": "Chicago"}, {"color": "blue", "multiplicity": 2, "name": "Denver"}, {"color": "blue", "multiplicity": 2, "name": "Frankfurt"}, {"color": "blue", "multiplicity": 3, "name": "London"}, {"color": "blue", "multiplicity": 3, "name": "New York"}, {"color": "blue", "multiplicity": 2, "name": "Paris"}, {"color": "blue", "multiplicity": 2, "name": "San Francisco"}, {"color": "blue", "multiplicity": 3, "name": "Washington"}, {"color": "black", "multiplicity": 3, "name": "Cairo"}, {"color": "black", "multiplicity": 3, "name": "Istanbul"}, {"color": "black", "multiplicity": 3, "name": "Tripoli"}, {"color": "yellow", "multiplicity": 2, "name": "Bogot\u00e0"}, {"color": "yellow", "multiplicity": 2, "name": "Buenos Aires"}, {"color": "yellow", "multiplicity": 3, "name": "Jacksonville"}, {"color": "yellow", "multiplicity": 1, "name": "Kinshasa"}, {"color": "yellow", "multiplicity": 3, "name": "Lagos"}, {"color": "yellow", "multiplicity": 1, "name": "Lima"}, {"color": "yellow", "multiplicity": 1, "name": "Los Angeles"}, {"color": "yellow", "multiplicity": 1, "name": "Mexico City"}, {"color": "yellow", "multiplicity": 1, "name": "Santiago"}, {"color": "yellow", "multiplicity": 3, "name": "S\u00e3o Paulo"}];
            $scope.state = new State($scope.cities);
            $scope.hist = [];
            $scope.epidemic = false;
            $scope.blockPlayerDeck = false;
